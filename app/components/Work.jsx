  ...
  return (
    ...
    id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
            Here are some of my recent projects. I take pride in delivering high-quality work that exceeds expectations.
        </motion.p>
        ...
        className='grid grid-cols-auto gap-5 my-10 dark:text-black'>
            {workData.map((project, index)=>(
                ...
                >
                    ...
                    {/* EXISTING WHITE INFORMATION BOX */}
                    <div className="
                        bg-white
                        w-10/12
                        rounded-md
        ...
        hover:bg-lightHover duration-500 dark:text-white dark:border-white dark:hover:bg-darkHover'>
            Show more 
            <Image src={isDarkMode ? assets.right_arrow_bold_dark : assets.right_arrow_bold} alt='Right rrow'
            className='w-4' />
        </motion.a>
    </motion.div>
  )
