...
const About = ({isDarkMode}) => {
  return (
    <motion.div id='about' className='w-full px-[12%] py-10 scroll-mt-8 mb-20'
    initial={{opacity: 0}}
    ...
    >
        ...
        className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
            ...
            className="w-full max-w-xs sm:max-w-sm rounded-3xl mx-auto overflow-hidden">
            ...
            className="flex-1">
                ...
                className='flex items-center gap-3 sm:gap-5'>
                    {toolsData.map((tool, index) => (
                        ...
                        className='flex items-center justify-center border-[0.5px] border-gray-400 rounded-lg p-3 cursor-pointer hover:-translate-y-1 duration-500'
                        key={index}>
